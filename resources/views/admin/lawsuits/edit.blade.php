            ...
            <div class="container">
                <div class="row">
                    <div class="col s12 m6 l6">
                        <h5 class="breadcrumbs-title mt-0 mb-0"><span>{{__('Uređivanje tuzbe')}}</span></h5>
                    </div>
                            ...
                            <div id="clendar" class="card">
                                <div class="card-content">
                                    <div class="card-title">
                                        <div class="row">
                                            <div class="col s12 m6 l6">
                                                <h4 class="card-title">{{__('Forma za uredjivanje tuzbe')}}</h4>
                                            </div>
                                            <div class="col s12 m6 l6">
                                    ...
                                    <div>
                                        {!! Form::model($lawsuit, array('method' => 'POST', 'url' => 'admin/lawsuits/update', 'class' => 'form-horizontal form-bordered form-validate', 'role' => 'form', 'novalidate' => 'novalidate', 'files' => true)) !!}
                                        @include('admin.forms.lawsuits', ['submit' => 'Uredi'])
                                        {!! Form::close() !!}
