        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m6 l6">
                    <h5 class="breadcrumbs-title mt-0 mb-0"><span>{{__('Skupštine stanara - sednice')}}</span></h5>
                </div>
                        ...
                        <div id="clendar" class="card">
                            <div class="card-content">
                                <div class="card-title">
                                    <div class="row">
                                        <div class="col s12 m6 l6">
                                            <h4 class="card-title">{{__('Forma za dodavanje sednice skupštine stanara')}}</h4>
                                        </div>
                                        <div class="col s12 m6 l6">
                                ...
                                <div>
                                    {!! Form::open(array('method' => 'POST', 'url' => 'admin/councils/storeMeeting', 'id' => 'fileupload', 'class' => 'form-horizontal form-bordered form-validate', 'role' => 'form', 'files' => true, 'enctype' => 'multipart/form-data')) !!}
                                    @include('admin.forms.councilmeeting', ['submit' => 'Dodaj'])
                                    {!! Form::close() !!}
