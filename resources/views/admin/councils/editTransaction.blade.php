                        ...
                        <div id="clendar" class="card">
                            <div class="card-content">
                                <div class="card-title">
                                    <div class="row">
                                        <div class="col s12 m6 l6">
                                            <h4 class="card-title">{{__('Forma za uredjivanje transakcije skupštine stanara')}}</h4>
                                        </div>
                                        <div class="col s12 m6 l6">
                                ...
                                <div>
                                    {!! Form::model($transaction, array('method' => 'POST', 'url' => 'admin/councils/updateTransaction', 'class' => 'form-horizontal form-bordered form-validate', 'role' => 'form', 'novalidate' => 'novalidate', 'files' => true)) !!}
                                    @include('admin.forms.counciltransaction', ['submit' => 'Uredi'])
                                    {!! Form::close() !!}
