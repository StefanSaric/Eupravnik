        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m6 l6">
                    <h5 class="breadcrumbs-title mt-0 mb-0"><span>{{__('Obaveze')}}</span></h5>
                </div>
                    ...
                    <div class="col s12">
                        <div id="clendar" class="card">
                            <div class="card-content">
                                ...
                                <div>
                                    {!! Form::open(array('method' => 'POST', 'url' => 'admin/duties/store', 'id' => 'fileupload', 'class' => 'form-horizontal form-bordered form-validate', 'role' => 'form', 'files' => true, 'enctype' => 'multipart/form-data')) !!}
                                    @include('admin.forms.duties', ['submit' => 'Dodaj'])
                                    {!! Form::close() !!}
