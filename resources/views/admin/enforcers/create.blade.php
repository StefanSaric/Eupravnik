                        ...
                        <div id="clendar" class="card">
                            <div class="card-content">
                                <div class="card-title">
                                    <div class="row">
                                        <div class="col s12 m6 l6">
                                            <h4 class="card-title">{{__('Forma za dodavanje izvršitelja')}}</h4>
                                        </div>
                                        <div class="col s12 m6 l6">
                                ...
                                <div>
                                    {!! Form::open(array('method' => 'POST', 'url' => 'admin/enforcers/store', 'id' => 'fileupload', 'class' => 'form-horizontal form-bordered form-validate', 'role' => 'form', 'files' => true, 'enctype' => 'multipart/form-data')) !!}
                                    @include('admin.forms.enforcers', ['submit' => 'Dodaj'])
                                    {!! Form::close() !!}
